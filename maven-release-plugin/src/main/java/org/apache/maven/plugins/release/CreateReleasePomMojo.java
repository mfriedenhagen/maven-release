...
/**
 * Creates the POM for a release in SCM. Steps through several phases to ensure the POM is ready to be released and then
 ...
 */
@Mojo( name = "create-release-pom", aggregator = true )
public class CreateReleasePomMojo
    extends AbstractScmReleaseMojo
{

    /**
     * Never resume a previous release attempt from the point where it was stopped
     * but do it freshly.
     */    
    ...
    /**
     * Goals to run as part of the preparation step, after transformation. Space delimited.
     */
    private String preparationGoals = "clean validate";
    ...
    /**
     * Commits to do are atomic or by project. TODO: not needed as no commit is done.
     */
